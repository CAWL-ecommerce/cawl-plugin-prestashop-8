    ...
    <div class="row">
      <div class="worldlineop-payment-methods-settings col-xs-12">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9 col-lg-offset-3">
              {if !$data.paymentMethodsSettings.isDefaultGenericLogo}
                ...
                <label for="worldlineopPaymentMethodsSettings[deleteGenericLogo]">{l s='Revert to default logo' mod='cawlop'}</label>
              {/if}
            <div class="help-block">
        ...
        <div class="form-group">
          <label class="control-label col-lg-3 ">
              <span>
                {l s='Fixed soft descriptor' mod='cawlop'}
              </span>
          </label>
          <div class="col-lg-9">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-9 col-lg-offset-3">
              {if !$data.paymentMethodsSettings.isDefaultIframeLogo}
                ...
                <label for="worldlineopPaymentMethodsSettings[deleteLogo]">{l s='Revert to default logo' mod='cawlop'}</label>
              {/if}
              <div class="help-block">
                {l s='You can upload here a new logo (file types accepted for logos are: .png .gif .jpg only)' mod='cawlop'}<br/>
                {l s='We recommend that you use images with 20px height & 120px length maximum' mod='cawlop'}
