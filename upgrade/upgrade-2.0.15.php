...
const PAYMENT_METHODS_SETTINGS_COLUMN_NAME = 'CAWLOP_PAYMENT_METHODS_SETTINGS';
const DEFAULT_GENERIC_LOGO_FILENAME = 'cawlop_symbol.png';
const DEFAULT_IFRAME_LOGO_FILENAME = 'cb_visa_mc_amex.svg';

/**
 * Updates module to the version 2.0.15
...
{
    $logger = $module->getLogger()->withName('Upgrade_2_0_15');
    $logger->info('Upgrade to v2.0.15 started');

    Shop::setContext(Shop::CONTEXT_ALL);
    if (Configuration::hasContext(PAYMENT_METHODS_SETTINGS_COLUMN_NAME, null, Shop::getContext())) {
        try {
            update_payment_methods_settings_2_0_15();
    ...
    $logger->info('Upgrade to v2.0.15 finished with success');
 ...
 * @throws Exception
 */
function update_payment_methods_settings_2_0_15()
{
